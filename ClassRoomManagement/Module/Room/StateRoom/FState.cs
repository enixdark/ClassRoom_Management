...
namespace CustomItem.Module{
    public partial class FstateStyle : RibbonForm
    {
        #region Fields
        ...
        public FstateStyle(DevExpress.XtraScheduler.SchedulerControl control, DevExpress.XtraScheduler.Appointment apt)
            : this(control, apt, false)
        {
        }
        public FstateStyle(DevExpress.XtraScheduler.SchedulerControl control, DevExpress.XtraScheduler.Appointment apt, bool openRecurrenceForm)
            : base()
        {
            if (control == null)
        ...
        protected internal virtual void LoadImages()
        {
            ...
            this.saveImage = LoadImageFromResource(FstateStyleImagesName.Save);
            this.saveLargeImage = LoadImageFromResource(FstateStyleImagesName.SaveLarge);
            this.saveAndCloseImage = LoadImageFromResource(FstateStyleImagesName.SaveAndClose);
            this.saveAndCloseLargeImage = LoadImageFromResource(FstateStyleImagesName.SaveAndCloseLarge);
            this.deleteImage = LoadImageFromResource(FstateStyleImagesName.Delete);
            this.deleteLargeImage = LoadImageFromResource(FstateStyleImagesName.DeleteLarge);
           
            this.closeImage = LoadImageFromResource(FstateStyleImagesName.Close);
            this.closeLargeImage = LoadImageFromResource(FstateStyleImagesName.CloseLarge);
        ...
        {
            if (((FstateStyle)sender).Controller == null)
                return;
        ...
        protected internal void UpdateCahoc()
        {
            ...
            l.ForEach(i =>
            {
                ...
                dic.Add(i.maca, new Nullable<System.TimeSpan>[] { i.thoigianbatdau, i.thoigianketthuc }); 
        ...
        private void lblHorzSeparator1_Click(object sender, EventArgs e)
        {
    ...
    public static class FstateStyleImagesName
    {
